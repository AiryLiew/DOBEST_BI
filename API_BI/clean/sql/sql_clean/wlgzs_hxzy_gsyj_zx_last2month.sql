drop table if exists www_bi_ads.wlgzs_hxzy_gsyj_zx_last2month;
CREATE TABLE www_bi_ads.wlgzs_hxzy_gsyj_zx_last2month ( 
select
a.classify_2 `产品小类` ,
a.`wuliaomc` `物料名称` ,
...
FROM erp_jd_dws.erp_jd_dws_doi_last2month x
