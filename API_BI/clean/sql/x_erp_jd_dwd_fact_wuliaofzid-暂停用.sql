...
CREATE TABLE erp_jd_dwd.erp_jd_dwd_fact_wuliaofzid (
      ...
      FROM erp_jd_ods.erp_jd_ods_dim_materialgroup_cwzx g
      ...
      left join(
            ...
            fparentid,
            fnumber
            FROM erp_jd_ods.erp_jd_ods_dim_materialgroup_cwzx 
      ...
      left join erp_jd_ods.erp_jd_ods_dim_materialgroupl_cwzx d on a.fid = d.fid
      left join erp_jd_ods.erp_jd_ods_dim_materialgroupl_cwzx e on b.fid = e.fid
      left join erp_jd_ods.erp_jd_ods_dim_materialgroupl_cwzx f on c.fid = f.fid
      left join erp_jd_ods.erp_jd_ods_dim_materialgroupl_cwzx h on g.fid = h.fid            
