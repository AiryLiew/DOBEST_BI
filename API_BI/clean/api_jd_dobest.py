...
# func("http://10.225.137.124:7772/ZyyxDSS/GetWuLiao",     "DOBEST",'erp_jd_ods_fact_classify_wc_dobest',        'erp_jd_ods_fact_classify_yc_dobest',        'erp_jd_ods_fact_classify_ms_dobest'    ,        'erp_jd_ods_fact_classify_kyk_dobest'   ,        'erp_jd_ods_fact_classify_kyok_dobest'   ,        'erp_jd_ods_fact_classify_wc01_dobest'  )
...
# func("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouTHD","DOBEST",'erp_jd_ods_dim_salereturn_wc_dobest',       'erp_jd_ods_dim_salereturn_yc_dobest',       'erp_jd_ods_dim_salereturn_ms_dobest' ,       'erp_jd_ods_dim_salereturn_kyk_dobest'   ,       'erp_jd_ods_dim_salereturn_kyok_dobest'     ,       'erp_jd_ods_dim_salereturn_wc01_dobest'  ,       'erp_jd_ods_dim_salereturn_kky_hz_dobest'  )
...
# func("http://10.225.137.124:7772/ZyyxDSS/GetZuZhuangCX", "DOBEST",'erp_jd_ods_dim_assemble_wc_dobest',         'erp_jd_ods_dim_assemble_yc_dobest',         'erp_jd_ods_dim_assemble_ms_dobest'   ,         'erp_jd_ods_dim_assemble_kyk_dobest' ,         'erp_jd_ods_dim_assemble_kyok_dobest' , 'erp_jd_ods_dim_assemble_wc01_dobest'     )
...
# func_QTCK("DOBEST",'erp_jd_ods_dim_othersshipping_wc_dobest',   'erp_jd_ods_dim_othersshipping_yc_dobest',   'erp_jd_ods_dim_othersshipping_ms_dobest'  ,       'erp_jd_ods_dim_othersshipping_kyk_dobest'  ,       'erp_jd_ods_dim_othersshipping_kyok_dobest','erp_jd_ods_dim_othersshipping_wc01_dobest' )
# func_QTCK("项目公司数据中心",'erp_jd_ods_dim_othersshipping_wc_xmgs',   'erp_jd_ods_dim_othersshipping_yc_xmgs',   'erp_jd_ods_dim_othersshipping_ms_xmgs'  ,       'erp_jd_ods_dim_othersshipping_kyk_xmgs'  ,       'erp_jd_ods_dim_othersshipping_kyok_xmgs','erp_jd_ods_dim_othersshipping_wc01_xmgs' )
...
# func("http://10.225.137.124:7772/ZyyxDSS/GetWuLiao",     "项目公司数据中心",'erp_jd_ods_fact_classify_wc_xmgs',        'erp_jd_ods_fact_classify_yc_xmgs',        'erp_jd_ods_fact_classify_ms_xmgs'  ,        'erp_jd_ods_fact_classify_kyk_xmgs'   ,        'erp_jd_ods_fact_classify_kyok_xmgs'   ,        'erp_jd_ods_fact_classify_wc01_xmgs'       )
...
func("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouDD", "项目公司数据中心",'erp_jd_ods_dim_saleorders_wc_xmgs',       'erp_jd_ods_dim_saleorders_yc_xmgs',       'erp_jd_ods_dim_saleorders_ms_xmgs'  ,       'erp_jd_ods_dim_saleorders_kyk_xmgs' ,       'erp_jd_ods_dim_saleorders_kyok_xmgs'   ,       'erp_jd_ods_dim_salereturn_wc01_xmgs'  ,       'erp_jd_ods_dim_salereturn_kky_hz_xmgs'      )
...
# func("http://10.225.137.124:7772/ZyyxDSS/GetZuZhuangCX", "项目公司数据中心",'erp_jd_ods_dim_assemble_wc_xmgs',         'erp_jd_ods_dim_assemble_yc_xmgs',         'erp_jd_ods_dim_assemble_ms_xmgs'  ,         'erp_jd_ods_dim_assemble_kyk_xmgs',         'erp_jd_ods_dim_assemble_kyok_xmgs',        'erp_jd_ods_dim_assemble_wc01_xmgs'       )
