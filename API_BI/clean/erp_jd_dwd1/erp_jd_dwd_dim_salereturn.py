...
df_saleReturn = pd.read_sql_query(text(""" 
                                    select riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company
                                    from erp_jd_ods.erp_jd_ods_dim_salereturn_wc_cwzx 
                                    ...
                                    union all 
                                    select riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company
                                    from erp_jd_ods.erp_jd_ods_dim_salereturn_yc_cwzx 
                                    where  riqi>=DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 63 DAY), '%Y-%m-01') and wuliaomc not in ('代收运费','测试物料1','管易云运费') and shenhezt in ('已审核','其他','审核中')

                                    union all 
                                    select riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company
                                    from erp_jd_ods.erp_jd_ods_dim_salereturn_kky_hz_cwzx 
                                    where  riqi>=DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 63 DAY), '%Y-%m-01') and wuliaomc not in ('代收运费','测试物料1','管易云运费') and shenhezt in ('已审核','其他','审核中')
                                                                        
									union all 
                                    select riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company
                                    from erp_jd_ods.erp_jd_ods_dim_salereturn_kyk_cwzx 
                                    where  riqi>=DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 63 DAY), '%Y-%m-01') and wuliaomc not in ('代收运费','测试物料1','管易云运费') and shenhezt in ('已审核','其他','审核中')
                                    
									union all 
                                    select riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company
                                    from erp_jd_ods.erp_jd_ods_dim_salereturn_wc01_cwzx 
...
insertsql(  df_saleReturn,
			...
			"""INSERT INTO erp_jd_dwd_dim_salereturn(riqi,wuliaobm,wuliaomc,shifasl,jiashuihj,hanshuidj,bumenbm,bumenmc,kehuid,kehumc,wuliaofzid,wuliaofzmc,shifouzp,beizhu,kucunzt,shenhezt,cangkuid,cangkumc,danjubh,xiaoshoucbj,chengbenj_bwb,zongchengb,zongchengb_bwb, company,bumen_new,bumen,year,month,cost,purchases,profit,refresh) 
