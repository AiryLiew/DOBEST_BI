...
# s1_funcB("http://10.225.137.124:7772/ZyyxDSS/GetTHSSTOCKDIMENSION",   'erp_jd_ods_dim_ths_stockdimension_cwzx' )
...
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetQiTaRKD",    "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_othersreceiving_kyk_cwzx'  )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetPanKuiD",    "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_inventoryloss_kyk_cwzx'    )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetPanYingD",   "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_inventoryprofit_kyk_cwzx'  )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetCaiGouRKD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_purchasereceiving_kyk_cwzx')
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetJiShouJSD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_consignment_kyk_cwzx'      )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetCaiGouTLD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_purchasereturn_kyk_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouDD", "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_saleorders_kyk_cwzx'       )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouTHD","上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_salereturn_kyk_cwzx'       )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouCKD","上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_saleshipping_kyk_cwzx'     )
s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetZuZhuangCX", "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_assemble_kyk_cwzx'         )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetFenBuSDRD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_distributedin_kyk_cwzx'    )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetFenBuSDCD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_distributedout_kyk_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetZhiJieDBD",  "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_allocation_kyk_cwzx'       )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetYingFuD",    "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_voucherpayable_kyk_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetTGLVOUCHER", "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_voucher_kyk_cwzx'          )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetWuLiaoSFHZ", "上海卡卡丫文化传播有限公司",'erp_jd_ods_dim_monthendinventory_kyk_cwzx')
...
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetJiShouJSD",  "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_consignment_kky_hz_cwzx'      )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetCaiGouTLD",  "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_purchasereturn_kky_hz_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetXiaoShouDD", "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_saleorders_kky_hz_cwzx'       )
...
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetFenBuSDRD",  "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_distributedin_kky_hz_cwzx'    )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetFenBuSDCD",  "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_distributedout_kky_hz_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetZhiJieDBD",  "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_allocation_kky_hz_cwzx'       )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetYingFuD",    "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_voucherpayable_kky_hz_cwzx'   )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetTGLVOUCHER", "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_voucher_kky_hz_cwzx'          )
# s_funcB("http://10.225.137.124:7772/ZyyxDSS/GetWuLiaoSFHZ", "杭州卡卡丫文化创意有限公司",'erp_jd_ods_dim_monthendinventory_kky_hz_cwzx')
